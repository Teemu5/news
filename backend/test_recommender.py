...
if __name__ == "__main__":
    ...
    main(dataset=args.dataset,
         ...
         data_dir_train="dataset/small/train/", data_dir_valid="dataset/small/valid/",
         zip_file_train="MINDsmall_train.zip", zip_file_valid="MINDsmall_dev.zip",
         user_category_profiles_path="small_user_category_profiles.pkl",
         user_cluster_df_path="small_user_cluster_df.pkl", cluster_id=args.cluster_id)
    """main(dataset=args.dataset,
         process_dfs=args.process_dfs, process_behaviors=args.process_behaviors,
